...
public class DataBaseMnist extends DataBase<double[]> {
	public DataBaseMnist(String trainingSetFilePath, String metricType, double _delta) throws FileNotFoundException {
		super(trainingSetFilePath, metricType, _delta);
	}
